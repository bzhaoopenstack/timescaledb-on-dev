...
excluded_by_constraint(PlannerInfo *root, RangeTblEntry *rte, Index rt_index, List *restrictinfos)
{
	RelOptInfo rel = {
		...
		.pruning_result = NULL,
		.partItrs = NULL,
		.pruning_result_for_index_usable = NULL,
		.partItrs_for_index_usable = NULL,
		.pruning_result_for_index_unusable = NULL,
		.partItrs_for_index_unusable = NULL,
		.bucketInfo = NULL,
		.subplan = NULL,
		.subroot = NULL,
		.subplan_params = NULL,
